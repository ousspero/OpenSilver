...
md temp
@echo OpenSilver SL.WorkInProgress 1.0.0-alpha-%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
echo. 
msbuild slnf/OpenSilver.slnf -p:Configuration=SL.WorkInProgress
echo. 
